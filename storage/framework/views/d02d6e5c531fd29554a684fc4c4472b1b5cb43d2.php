                    ...
                    <div class="card" style="margin-bottom: 10px">
                        ...
                        <div class="card-body">
                            <?php if(!empty($ad['picture1'])): ?>
                                <div id="carouselExampleIndicators" class="carousel slide <?php echo e($c); ?>" data-ride="carousel">
